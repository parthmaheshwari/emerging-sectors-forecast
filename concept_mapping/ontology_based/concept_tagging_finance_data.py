...
from concept_tagging_utilities import convert_finance_csv_to_jsonl, prepare_json_for_finance_data


if __name__ == "__main__":

    # use convert_finance_csv_to_jsonl to convert pandas file to jsonl to run below code
    ...
    for fileidx, filepath in enumerate(all_data_files):
        ...
        input_data_for_concept_tagger = prepare_json_for_finance_data(all_data, unique_key_in_data=unique_key_in_data)
