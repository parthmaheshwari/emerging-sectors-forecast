...
if __name__ == "__main__":
    ...
    all_abstracts_data_files = sorted([os.path.join(main_path_abstracts_data, f) for f in os.listdir(main_path_abstracts_data)])

    print('Total files to be processed are : {}'.format(len(all_abstracts_data_files)))

    for fileidx, filepath in enumerate(all_abstracts_data_files):
